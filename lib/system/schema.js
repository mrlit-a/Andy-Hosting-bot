module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('owners' in setting)) setting.owners = ['13092208152']
      if (!isNumber(setting.lastReset)) setting.lastReset = new Date * 1
      if (!('msg' in setting)) setting.msg = 'Hi +tag 🪸\nI am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n◦ *DASH URL* : https://dash.andylit.online\n◦ *PANEL URL* : https://panel.andylit.online\n\nIf you find an error or want to upgrade premium plan contact the owner.'
      if (!isNumber(setting.style)) setting.style = 4
      if (!('cover' in setting)) setting.cover = 'https://telegra.ph/file/03dbc8b9c0ab44ebd9203.jpg'
      if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/EtcDu53IvhwKZNPIII7wM3'
   } else {
      global.db.setting = {
         autodownload: true,
         antispam: true,
         ...
         msg: 'Hi +tag 🪸\nI am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n◦ *DASH URL* : https://dash.andylit.online\n◦ *PANEL URL* : https://panel.andylit.online\n\nIf you find an error or want to upgrade premium plan contact the owner.',
         style: 4,
         cover: 'https://telegra.ph/file/03dbc8b9c0ab44ebd9203.jpg',
         link: 'https://chat.whatsapp.com/EtcDu53IvhwKZNPIII7wM3'
      }
   }
}